  ...
  const benefits = [
    {
      ...
      description: "Create memorable logos and consistent visual identity across all platforms. It's the foundation of your brand's personality."
    },
    {
      icon: <FaUsers />,
      title: "Customer Engagement",
      description: "Well-designed banners, social media posts, brochures, and flyers grab attention and drive action."
    },
    {
      icon: <FaChartLine />,
      title: "Competitive Advantage",
      description: "Brands with refined visual presentation outperform their competition in customer retention and marketing ROI."
    },
    {
      icon: <FaComments />,
      title: "Communication Efficiency",
      description: "A single visual can convey messages that would take paragraphs to write. Design enhances clarity and emotion."
    },
    {
      icon: <FaTrophy />,
      title: "Marketing Success",
      description: "Campaigns with strong graphics generate higher impressions, engagement, and conversions."
    }
  ];
